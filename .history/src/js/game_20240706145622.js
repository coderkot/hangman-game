import { WORDS, KEYBOARD, TRIES, RESULT, TRIES_TEXT, RESULT_WORD } from './consts'
...
const stopGame = (status) => {
	...
	game.innerHTML += `<p>${RESULT_WORD[lang]}<span class='resul>${word}</span></p>`
}
...
export const startGameHandler = () => {
	...
	gameDiv.innerHTML +=
		`<p id="tries" class="mt-2">${TRIES_TEXT[lang]}: <span id="tries-left" class="font-medium text-red-600">${TRIES}</span></p>`
